...
public class ButtonMapping {
	public static final ButtonMapping LIFT_RAISE		= new ButtonMapping(Controllers.CONTROLLER_SECCONDARY, 	Buttons.A			);
	public static final ButtonMapping LIFT_LOWER		= new ButtonMapping(Controllers.CONTROLLER_SECCONDARY, 	Buttons.B			);
