...
public final class PIDControllerType extends ComplexDataType<PIDControllerData> {
  ...
  public static final edu.wpi.first.shuffleboard.plugin.base.data.types.PIDControllerType Instance = new edu.wpi.first.shuffleboard.plugin.base.data.types.PIDControllerType();
