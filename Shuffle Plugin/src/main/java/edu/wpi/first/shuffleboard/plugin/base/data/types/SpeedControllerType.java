...
public final class SpeedControllerType extends ComplexDataType<SpeedControllerData> {
  ...
  public static final edu.wpi.first.shuffleboard.plugin.base.data.types.SpeedControllerType Instance = new edu.wpi.first.shuffleboard.plugin.base.data.types.SpeedControllerType();
