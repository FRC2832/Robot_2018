...
public final class MecanumDriveType extends ComplexDataType<MecanumDriveData> {
  ...
  public static final edu.wpi.first.shuffleboard.plugin.base.data.types.MecanumDriveType Instance = new edu.wpi.first.shuffleboard.plugin.base.data.types.MecanumDriveType();
