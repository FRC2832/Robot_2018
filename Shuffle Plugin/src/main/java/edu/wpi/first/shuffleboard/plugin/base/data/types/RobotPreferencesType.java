...
public final class RobotPreferencesType extends ComplexDataType<RobotPreferencesData> {
  ...
  public static final edu.wpi.first.shuffleboard.plugin.base.data.types.RobotPreferencesType Instance = new edu.wpi.first.shuffleboard.plugin.base.data.types.RobotPreferencesType();
