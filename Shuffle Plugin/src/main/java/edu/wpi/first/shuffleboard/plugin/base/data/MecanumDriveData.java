 ...
 */
public final class MecanumDriveData extends ComplexData<edu.wpi.first.shuffleboard.plugin.base.data.MecanumDriveData> {
   ...
   */
  public static edu.wpi.first.shuffleboard.plugin.base.data.MecanumDriveData fromMap(Map<String, ?> map) {
    return new edu.wpi.first.shuffleboard.plugin.base.data.MecanumDriveData(
  ...
  public edu.wpi.first.shuffleboard.plugin.base.data.MecanumDriveData withFrontLeftSpeed(double frontLeftSpeed) {
    return new edu.wpi.first.shuffleboard.plugin.base.data.MecanumDriveData(frontLeftSpeed, frontRightSpeed, rearLeftSpeed, rearRightSpeed);
  }

  public edu.wpi.first.shuffleboard.plugin.base.data.MecanumDriveData withFrontRightSpeed(double frontRightSpeed) {
    return new edu.wpi.first.shuffleboard.plugin.base.data.MecanumDriveData(frontLeftSpeed, frontRightSpeed, rearLeftSpeed, rearRightSpeed);
  }

  public edu.wpi.first.shuffleboard.plugin.base.data.MecanumDriveData withRearLeftSpeed(double rearLeftSpeed) {
    return new edu.wpi.first.shuffleboard.plugin.base.data.MecanumDriveData(frontLeftSpeed, frontRightSpeed, rearLeftSpeed, rearRightSpeed);
  }

  public edu.wpi.first.shuffleboard.plugin.base.data.MecanumDriveData withRearRightSpeed(double rearRightSpeed) {
    return new edu.wpi.first.shuffleboard.plugin.base.data.MecanumDriveData(frontLeftSpeed, frontRightSpeed, rearLeftSpeed, rearRightSpeed);
  }
  ...
  public boolean equals(Object o) {
    ...
    edu.wpi.first.shuffleboard.plugin.base.data.MecanumDriveData that = (edu.wpi.first.shuffleboard.plugin.base.data.MecanumDriveData) o;
