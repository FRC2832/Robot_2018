...
public final class CommandType extends ComplexDataType<CommandData> {
  ...
  public static final edu.wpi.first.shuffleboard.plugin.base.data.types.CommandType Instance = new edu.wpi.first.shuffleboard.plugin.base.data.types.CommandType();
