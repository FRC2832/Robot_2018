...
public final class SubsystemType extends ComplexDataType {
  ...
  public static final edu.wpi.first.shuffleboard.plugin.base.data.types.SubsystemType Instance = new edu.wpi.first.shuffleboard.plugin.base.data.types.SubsystemType();
