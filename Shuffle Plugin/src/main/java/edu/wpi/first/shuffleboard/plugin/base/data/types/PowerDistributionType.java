...
public final class PowerDistributionType extends ComplexDataType<PowerDistributionData> {
  ...
  public static final edu.wpi.first.shuffleboard.plugin.base.data.types.PowerDistributionType Instance = new edu.wpi.first.shuffleboard.plugin.base.data.types.PowerDistributionType();
