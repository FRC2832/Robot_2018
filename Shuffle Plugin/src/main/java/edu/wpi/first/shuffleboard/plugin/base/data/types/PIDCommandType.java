...
public final class PIDCommandType extends ComplexDataType<PIDCommandData> {
  ...
  public static final edu.wpi.first.shuffleboard.plugin.base.data.types.PIDCommandType Instance = new edu.wpi.first.shuffleboard.plugin.base.data.types.PIDCommandType();
