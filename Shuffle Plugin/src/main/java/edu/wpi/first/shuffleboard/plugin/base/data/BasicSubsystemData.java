...
public final class BasicSubsystemData extends ComplexData<edu.wpi.first.shuffleboard.plugin.base.data.BasicSubsystemData> {
  ...
  public boolean equals(Object o) {
    ...
    edu.wpi.first.shuffleboard.plugin.base.data.BasicSubsystemData that = (edu.wpi.first.shuffleboard.plugin.base.data.BasicSubsystemData) o;
