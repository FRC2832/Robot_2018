...
public final class GyroData extends ComplexData<edu.wpi.first.shuffleboard.plugin.base.data.GyroData> {
  ...
  public boolean equals(Object obj) {
    ...
    edu.wpi.first.shuffleboard.plugin.base.data.GyroData that = (edu.wpi.first.shuffleboard.plugin.base.data.GyroData) obj;
