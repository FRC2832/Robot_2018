...
public final class PIDControllerData extends ComplexData<edu.wpi.first.shuffleboard.plugin.base.data.PIDControllerData> {
  ...
  public edu.wpi.first.shuffleboard.plugin.base.data.PIDControllerData withP(double p) {
    return new edu.wpi.first.shuffleboard.plugin.base.data.PIDControllerData(p, i, d, f, setpoint, enabled);
  }

  public edu.wpi.first.shuffleboard.plugin.base.data.PIDControllerData withI(double i) {
    return new edu.wpi.first.shuffleboard.plugin.base.data.PIDControllerData(p, i, d, f, setpoint, enabled);
  }

  public edu.wpi.first.shuffleboard.plugin.base.data.PIDControllerData withD(double d) {
    return new edu.wpi.first.shuffleboard.plugin.base.data.PIDControllerData(p, i, d, f, setpoint, enabled);
  }

  public edu.wpi.first.shuffleboard.plugin.base.data.PIDControllerData withF(double f) {
    return new edu.wpi.first.shuffleboard.plugin.base.data.PIDControllerData(p, i, d, f, setpoint, enabled);
  }

  public edu.wpi.first.shuffleboard.plugin.base.data.PIDControllerData withSetpoint(double setpoint) {
    return new edu.wpi.first.shuffleboard.plugin.base.data.PIDControllerData(p, i, d, f, setpoint, enabled);
  }

  public edu.wpi.first.shuffleboard.plugin.base.data.PIDControllerData withEnabled(boolean enabled) {
    return new edu.wpi.first.shuffleboard.plugin.base.data.PIDControllerData(p, i, d, f, setpoint, enabled);
  }
  ...
  public boolean equals(Object obj) {
    ...
    edu.wpi.first.shuffleboard.plugin.base.data.PIDControllerData that = (edu.wpi.first.shuffleboard.plugin.base.data.PIDControllerData) obj;
