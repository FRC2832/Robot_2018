...
public final class ThreeAxisAccelerometerData extends ComplexData<edu.wpi.first.shuffleboard.plugin.base.data.ThreeAxisAccelerometerData> {
  ...
  public boolean equals(Object obj) {
    ...
    edu.wpi.first.shuffleboard.plugin.base.data.ThreeAxisAccelerometerData that = (edu.wpi.first.shuffleboard.plugin.base.data.ThreeAxisAccelerometerData) obj;
