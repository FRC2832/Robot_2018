...
public final class GyroType extends ComplexDataType<GyroData> {
  ...
  public static final edu.wpi.first.shuffleboard.plugin.base.data.types.GyroType Instance = new edu.wpi.first.shuffleboard.plugin.base.data.types.GyroType();
