...
public class CommandData extends ComplexData<edu.wpi.first.shuffleboard.plugin.base.data.CommandData> {
  ...
  public edu.wpi.first.shuffleboard.plugin.base.data.CommandData withRunning(boolean running) {
    return new edu.wpi.first.shuffleboard.plugin.base.data.CommandData(this.name, running, this.isParented);
  }
