...
public final class EncoderType extends ComplexDataType<EncoderData> {
  ...
  public static final edu.wpi.first.shuffleboard.plugin.base.data.types.EncoderType Instance = new edu.wpi.first.shuffleboard.plugin.base.data.types.EncoderType();
