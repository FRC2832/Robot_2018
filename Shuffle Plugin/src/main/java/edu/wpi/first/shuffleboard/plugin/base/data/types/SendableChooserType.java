...
public final class SendableChooserType extends ComplexDataType<SendableChooserData> {
  ...
  public static final edu.wpi.first.shuffleboard.plugin.base.data.types.SendableChooserType Instance = new edu.wpi.first.shuffleboard.plugin.base.data.types.SendableChooserType();
