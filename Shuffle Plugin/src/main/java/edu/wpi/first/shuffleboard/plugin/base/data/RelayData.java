...
public class RelayData extends ComplexData<edu.wpi.first.shuffleboard.plugin.base.data.RelayData> {
  ...
  public edu.wpi.first.shuffleboard.plugin.base.data.RelayData withState(State state) {
    return new edu.wpi.first.shuffleboard.plugin.base.data.RelayData(this.name, state);
  }
